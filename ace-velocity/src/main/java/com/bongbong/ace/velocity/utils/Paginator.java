...
public class Paginator {
    ...
    public Paginator(int sizePerPage, int totalElements) {
        if (sizePerPage < 1) throw new IllegalArgumentException("sizePerPage cannot be less than 1");
        if (totalElements < 0) throw new IllegalArgumentException("totalElements cannot be less than 0");
